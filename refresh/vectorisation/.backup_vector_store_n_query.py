...
def query_from_vector(query):
    ...
    vector_folder_name = f"data/vectors/artist_atget_eugene"
...
merge_db()
# print(query_from_vector("When was the Abbott's book on Atget published and what was the books name"))